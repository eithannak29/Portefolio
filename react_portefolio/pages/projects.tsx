...
function Project({ name, description, link, icons }: ProjectProps, { color }: ColorProp) {
  return (
    <div className="bg-white bg-opacity-50 rounded-md p-5 shadow-md transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
      ...
      <h3 className={`text-2xl text-${color}-400 font-medium font-montserrat`}>
          {name}
        </h3>
      ...
      <a
        href={link}
        className={`bg-gray-500 hover:bg-${color}-600 text-white font-medium py-2 px-4 rounded-full`}
      >
        View
      </a>
    </div>
