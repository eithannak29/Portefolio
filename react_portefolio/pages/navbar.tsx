...
export default function NavBar({ color }: ColorProp)
{
    return(
        ...
        <nav className="flex items-center justify-between p-4 text-white">
          ...
          <a className={`text-lg px-4 hover:text-${color}-400`} href="#Home">
              Home
            </a>
            <a className={`text-lg px-4 hover:text-${color}-400`} href="#Projects">
              Projects
            </a>
            <a className={`text-lg px-4 hover:text-${color}-400`} href="#Skills">
              Skills
            </a>
            <a className={`text-lg px-4 hover:text-${color}-400`} href="#Contact">
              Contact
            </a>
          </div>
        </nav>
        ...
        <div id="Home" className="text-center p-10">
          <h1 className={`text-5xl text-${color}-400 font-medium font-montserrat`}>
            Eithan Nakache
          </h1>
        ...
        <div className={`relative mx-auto bg-gradient-to-b from-${color}-400 rounded-full w-80 h-80 mt-20 overflow-hidden`}>
          <Image
