    ...
    <section id="About_Me" className="min-h-screen">
      <nav className="flex items-center justify-between p-4 text-white">
        <div className="flex items-center ml-auto bg-gray-800 bg-opacity-50 rounded-md ">
          <a
            className={`text-lg px-4 hover:text-${isBlueColor ? "blue" : "red"}-400`}
            href="#Home"
          >
            Home
          </a>
      ...
      <div id="Home" className="text-center p-10">
        <h1
          className={`text-5xl text-${isBlueColor ? "blue" : "red"}-400 font-medium font-montserrat`}
        >
          Eithan Nakache
        </h1>
      ...
      <div
        className={`relative mx-auto bg-gradient-to-b from-${
          isBlueColor ? "blue" : "red"
        }-400 rounded-full w-80 h-80 mt-20 overflow-hidden`}
      >
