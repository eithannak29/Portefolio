...
function CreateSticker({ link }: StickerProps) {
  return (
    <li className="py-3">
      <img
        className="object-scale-down h-14 w-24 transform transition-all duration-300 hover:scale-105 hover:shadow-lg"
        src={link}
        alt=""
      />
    </li>
  ...
  return (
    <div className="">
      <section className="py-10">
        <h2
          id="Skills"
          className="text-5xl text-center text-white font-medium font-montserrat"
        >
          Skills
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 gap-10 mt-10">
          <div className="bg-gray-800 bg-opacity-90 rounded-md p-5 shadow-md shadow-black/50" id="Languages">
            <h3 className="text-xl text-white font-medium font-montserrat border-b-4 border-blue-500">
              Languages
            </h3>
          ...
          <div className="bg-gray-800 bg-opacity-90 rounded-md p-5 shadow-md shadow-black/50" id="Tools">
            <h3 className="text-xl text-white font-medium font-montserrat border-b-4 border-blue-500">
              Tools
            </h3>
            <ul className="py-5 flex flex-wrap justify-center">
